...
import cat.copernic.erpInsCavallBernat.DAO.RolDAO;
    ...
    */    
    ...
    public Rol cercarRol(Rol rol) {
        ...
        */ 
        ...
        return this.rol.findById(rol.getId_rol()).orElse(null);
